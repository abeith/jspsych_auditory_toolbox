class AVWorkletProcessor extends AudioWorkletProcessor {
    ...
    process(inputs, outputs, parameters) {
        const triggerValue = Math.max(...parameters.trigger);

        if(triggerValue > this._trigger){
            this._sendTrigger(triggerValue);
        };
...
registerProcessor("av-worklet", AVWorkletProcessor);
